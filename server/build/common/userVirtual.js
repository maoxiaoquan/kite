...
class userVirtual {
    ...
    static isVirtual(vrData) {
        ...
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            let isPlus = constant_1.virtualInfo[virtualData.action].plusLess === constant_1.virtualPlusLess.plus;
            let amount = constant_1.virtualInfo[virtualData.action][virtualData.type];
            ...
            try {
                ...
                yield models.sequelize.transaction((t) => {
                    ...
                    return models.virtual
                        ...
                        // 用户虚拟币消息记录
                        plus_less: constant_1.virtualInfo[virtualData.action].plusLess, balance, income: isPlus
                            ? constant_1.virtualInfo[virtualData.action][virtualData.type]
                            : 0, expenses: isPlus
                            ? 0
                            : constant_1.virtualInfo[virtualData.action][virtualData.type], amount: constant_1.virtualInfo[virtualData.action][virtualData.type] }, virtualData), { transaction: t })
                        .then((user) => {
