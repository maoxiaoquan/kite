...
class dynamicComment {
    ...
    static updateComment(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield yield models.dynamic_comment.update({
    ...
    static deleteComment(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.body;
            try {
                let oneComment = yield models.dynamic_comment.findOne({ where: { id } });
                yield models.dynamic_comment.destroy({ where: { id } });
                let dynamicCommentCount = yield models.dynamic_comment.count({
                    where: {
