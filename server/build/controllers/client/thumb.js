...
const { statusList: { reviewSuccess, freeReview, pendingReview, reviewFail, deletes }, articleType, userMessageAction, userMessageActionText, modelAction, virtualType, modelType, modelInfo } = require('../../utils/constant');
            ...
            try {
                ...
                if (oneAttention) {
                    ...
                    yield userMessage.setMessage({
                        ...
                        sender_id: user.uid,
                        action: userMessageAction.thumb,
                        type: type,
                ...
                yield models[modelInfo[type].model].update(
                // 更新点赞数
                {
