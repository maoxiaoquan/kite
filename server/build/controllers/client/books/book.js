...
const { statusList: { reviewSuccess, freeReview, pendingReview, reviewFail, deletes }, articleType, userMessageAction, modelAction, virtualType, productType, trialRead, isFree, modelType } = require('../../../utils/constant');
    ...
    static getBookInfo(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (oneBook) {
                    if (oneBooks.is_free === isFree.free ||
