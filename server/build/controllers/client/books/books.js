    ...
    static createBooks(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let userInfo = yield models.user_info.findOne({
                    where: {
                        uid: user.uid
                    }
                });
                if (userInfo.experience < constant_1.userLevel.three) {
            ...
            try {
                ...
                if (books) {
                    ...
                    books.setDataValue('trialReadCount', yield models.book.count({
                        where: { books_id, trial_read: constant_1.trialRead.yes }
                    }));
                    ...
                    if (books.status === constant_1.statusList.deleted) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                let { count, rows } = yield models.collect.findAndCountAll({
                    where: { is_associate: true, uid, type: constant_1.modelName.books },
                    offset: (page - 1) * pageSize,
