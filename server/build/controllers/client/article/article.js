...
const { statusList: { reviewSuccess, freeReview, pendingReview, reviewFail, deleted }, articleType, modelType, userMessageAction, modelAction, virtualType } = require('../../../utils/constant');
    ...
    static getArticleColumnList(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (let i in rows) {
                    let tag_id = rows[i].tag_ids.length === 1
                        ? rows[i].tag_ids
