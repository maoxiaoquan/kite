...
const { statusList: { reviewSuccess, freeReview, pendingReview, reviewFail, deletes }, userMessageAction, modelAction, virtualType, modelType } = require('../../../utils/constant');
                ...
                yield models.article_comment
                    ...
                    if (oneArticle.uid !== user.uid && !reqData.reply_id) {
                        ...
                        yield userMessage.setMessage({
                            uid: oneArticle.uid,
                            sender_id: user.uid,
                            action: userMessageAction.comment,
                    ...
                    if (reqData.reply_id &&
                        ...
                        yield userMessage.setMessage({
                            ...
                            sender_id: user.uid,
                            action: userMessageAction.reply,
                            type: modelType.article_comment,
                            content: JSON.stringify({
                    ...
                    resClientJson(res, {
                        state: 'success',
                        data: _data,
                        message: Number(status) === freeReview ? '评论成功' : '评论成功,正在审核中'
                    });
                }))
                    .catch((err) => {
                    resClientJson(res, {
