...
class articleBlog {
   ...
   */
  static async getUserArticleBlogAll(req: any, res: any, next: any) {
    /* 获取所有文章专题 */
    let { uid } = req.query
    try {
   ...
   * @param   {object} ctx 上下文对象
   */
  static async createUserArticleBlog(req: any, res: any, next: any) {
    /* 创建用户专题 */
   ...
   * @param   {object} ctx 上下文对象
   */
  static async updateUserArticleBlog(req: any, res: any, next: any) {
  ...
  static async deleteUserArticleBlog(req: any, res: any, next: any) {
    const resData = req.body
    let { user = '' } = req
    try {
  ...
  static async getArticleBlogView(req: any, res: any, next: any) {
  ...
  // 获取个人专栏所含有的文章
  static async getArticleBlogArticleList(req: any, res: any, next: any) {
  ...
  static async getLikeArticleBlogList(req: any, res: any, next: any) {
    let page = req.query.page || 1
    let pageSize = req.query.pageSize || 24
