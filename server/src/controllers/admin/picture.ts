...
class Picture {
   ...
   */
  static async createPicture(req: any, res: any, next: any) {
   ...
   * @param   {object} ctx 上下文对象
   */
  static async getPictureList(req: any, res: any, next: any) {
   ...
   * @param   {object} ctx 上下文对象
   */
  static async updatePicture(req: any, res: any, next: any) {
    const reqData = req.body
    try {
   ...
   * 删除标签
   */
  static async deletePicture(req: any, res: any, next: any) {
