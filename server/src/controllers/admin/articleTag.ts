...
class ArticleTag {
   ...
   */
  static async createArticleTag(req: any, res: any, next: any) {
   ...
   * @param   {object} ctx 上下文对象
   */
  static async updateArticleTag(req: any, res: any, next: any) {
    const reqData = req.body
    try {
   ...
   * 删除标签
   */
  static async deleteArticleTag(req: any, res: any, next: any) {
