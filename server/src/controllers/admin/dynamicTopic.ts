...
class dynamicTopic {
   ...
   */
  static async createDynamicTopic(req: any, res: any, next: any) {
   ...
   * @param   {object} ctx 上下文对象
   */
  static async getDynamicTopicList(req: any, res: any, next: any) {
   ...
   * @param   {object} ctx 上下文对象
   */
  static async getDynamicTopicAll(req: any, res: any, next: any) {
    try {
   ...
   * @param   {object} ctx 上下文对象
   */
  static async updateDynamicTopic(req: any, res: any, next: any) {
    const reqData = req.body
    try {
   ...
   * 删除专题
   */
  static async deleteDynamicTopic(req: any, res: any, next: any) {
