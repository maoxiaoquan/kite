...
class ArticleColumn {
   ...
   */
  static async createArticleColumn(req: any, res: any, next: any) {
   ...
   * @param   {object} ctx 上下文对象
   */
  static async updateArticleColumn(req: any, res: any, next: any) {
    const reqData = req.body
   ...
   * 删除标签
   */
  static async deleteArticleColumn(req: any, res: any, next: any) {
