...
class AdminSystemLog {
  ...
  static async createAdminSystemLog({ uid, type = 1, content }: any) {
   ...
   * @param   {object} ctx 上下文对象
   */
  static async getAdminSystemLogList(req: any, res: any, next: any) {
   ...
   * 删除后台系统日志
   */
  static async deleteAdminSystemLog(req: any, res: any, next: any) {
    const { id } = req.body
    try {
