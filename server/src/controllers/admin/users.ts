...
class Users {
   ...
   * @param   {object} ctx 上下文对象
   */
  static async editUser(req: any, res: any, next: any) {
   ...
   * @param   {object} ctx 上下文对象
   */
  static async getAvatarReview(req: any, res: any, next: any) {
   ...
   * @param   {object} ctx 上下文对象
   */
  static async set_avatar_review(req: any, res: any, next: any) {
    try {
   ...
   * @param   {object} ctx 上下文对象
   */
  static async banUser(req: any, res: any, next: any) {
    try {
