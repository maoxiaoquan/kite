...
export const otherStatusListText = {
  // 所有内容的审核状态文字
  [otherStatusList.pendingReview]: '待审核', // 待审核
  [otherStatusList.reviewSuccess]: '审核成功', // 审核成功
  [otherStatusList.reviewFail]: '审核失败', // 审核失败
  [otherStatusList.freeReview]: '免审核' // 免审核
}
