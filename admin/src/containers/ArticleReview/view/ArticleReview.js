...
import './ArticleReview.scss'
import {
  get_article_list,
  edit_user,
  delete_article
} from '../actions/ArticleReviewAction'
import alert from '../../../utils/alert'
import state_article_review from '../reducer/ArticleReviewReducer'
...
class ArticleReview extends React.Component {
  ...
  editUser (val) {
    ...
    this.props.dispatch({type: 'ARTICLE_REVIEW_SET_CURRENT_INFO', data: val})
  ...
  render () {
    ...
    const {state_article_review = {}} = this.props
    ...
    return (
      ...
      <div className="layout-main">
        ...
        <div className="admin-article-review">

          <div className="article-review-aside">
          ...
          <div className="article-review-content">
            <div className="layout-table">
              <Table
                ...
                dataSource={state_article_review.list}
                loading={loading}
...
const ArticleForm = Form.create()(ArticleReview)

export default connect(({state_article_review}) => {
  return {
