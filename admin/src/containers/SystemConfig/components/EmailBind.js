    ...
    return (
      <div className="layout-main" id="system-config">
        <div className="layout-main-title">
          <h4 class="header-title">邮箱修改or绑定</h4>
        </div>
        ...
        <div className="card layout-card-view">
          <div className="card-body sc-content-view">
            <Form className="from-view" onSubmit={this.handleSubmit.bind(this)}>
              ...
              <FormItem {...formItemLayout} label="系统邮箱">
              ...
              {this.state.type === 'company' ? (
                <div>
                  <FormItem {...formItemLayout} label="服务商服务器地址">
                  ...
                  <FormItem {...formItemLayout} label="系统邮箱服务商端口">
                ...
                <FormItem {...formItemLayout} label="系统邮箱服务商后缀">
              ...
              <FormItem {...formItemLayout} label="系统邮箱密码">
