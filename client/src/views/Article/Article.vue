<template>
  <section class="article-lay layout-content box-container" id="article-lay">
    <div class="container-article">
      <div class="row">
        <main class="lay-main col-xs-12 col-sm-12 col-md-12" v-if="article.aid">
          <div class="article-view">
            <div class="article-title">
              <h1>{{article.title }}</h1>
              <div class="author">
                <router-link :to="{name:'user',params:{uid:article.user.uid}}" class="avatar">
                  <img :src="article.user.avatar" alt />
                </router-link>
                <div class="info">
                  <div class="name">
                    <router-link
                      :to="{name:'user',params:{uid:article.user.uid}}"
            ...
            <div class="follow-detail">
              <div class="info">
                ...
                <a
                  class="btn btn-success follow attention-article"
        ...
        <main class="lay-main col-xs-12 col-sm-12 col-md-12" v-else>
