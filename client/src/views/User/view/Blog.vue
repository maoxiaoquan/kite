<template>
  <div class="user-article-blog" v-loading="isLoading">
    <button
      class="btn create-article-blog"
        ...
        <div class="user-article-blog-item client-card">
          ...
          <div class="user-article-blog-tag">
            ...
            <template v-if="articleBlogItem.tag">
              <router-link
                v-for="(itemArticleTag, key) in articleBlogItem.tag"
          ...
          <div class="user-article-blog-main">
            <p class="description" v-if="articleBlogItem.status !== 3">
              介绍：{{ articleBlogItem.description || '没有写入介绍' }}
            </p>
            <p class="description faild" v-else>
    ...
    <Page
      :total="Number(articleBlog.count)"
    ...
    >
      <div class="blog-modal">
        ...
        <div class="form-group avatar-uploader avatar-uploader">
          ...
          <div class="avatar" v-if="blogForm.icon">
            <img class="avatar-img" v-lazy="blogForm.icon" alt="" />
          </div>
          <div class="action-box">
            <div class="hint">支持 jpg、png 格式大小 1M 以内的图片</div>
            <upload-image
              class="upload-image"
              @changeUpload="changeArticleBlogImg"
              >上传图片</upload-image
            >
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <select v-model="blogForm.tag_ids" placeholder="请选择">
            <option
              v-for="(item, key) in articleTagAll"
              :key="key"
              :label="item.name"
              :value="item.tag_id"
            >
