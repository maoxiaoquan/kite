...
/*前台用户角色表*/
const user_tag = sequelize.define(
...
/*前台用户浏览行为表*/
const user_behavior = sequelize.define(
...
/*用户与角色关系表*/
const admin_user_role = sequelize.define(
...
/*角色与权限关系表*/
const admin_role_authority = sequelize.define(
